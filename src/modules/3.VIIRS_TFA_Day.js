/**
 * Module: 3.VIIRS_TFA_Day.js
 * Temporal Fourier Analysis for VIIRS day temperatures
 */
...
const Temperature_Band = 'LST_1KM';

// Insert here the coordinates of the area of interest
const geometria = table;

// Change the path to your own assets folder
const Assets_path = 'users/corfobbppciren2023/GCOM_LST_TFA_Valparaiso_';

const collection = 'NASA/VIIRS/002/VNP21A1D'; // VIIRS
